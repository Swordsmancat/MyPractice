...
namespace Farm.Hotfix
{
    public class GameHotfixEntry
    {
        ...
        public static EnergyBarComponent EnergyBar
        {
            get;
            private set;
        }

        public static DamageHUDComponent DamageHUD
        {
            get;
            private set;
        }
        ...
        private static void OnLoadAssetSuccess(string assetName, object asset, float duration, object userdata)
        {
            ...
            HPBar = game.transform.Find("HP Bar").GetComponentInChildren<HPBarComponent>();
            DamageHUD = game.transform.Find("DamageHUD").GetComponentInChildren<DamageHUDComponent>();
            EnergyBar = game.transform.Find("EnergyBar").GetComponentInChildren<EnergyBarComponent>();
        }

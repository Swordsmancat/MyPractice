   ...
   public class PlayerData:TargetableObjectData
    {
        ...
        [SerializeField, GUIColor(1, 0, 0), HideLabel]
        [LabelText("盾反顿帧时间")]
        private float m_StopFrameTime = 0.2f;

        [SerializeField, GUIColor(1, 0, 0), HideLabel]
        [LabelText("盾反顿帧强度")]
        [Range(0.2f,1f)]
        private float m_StopFrameSize = 0.8f;
        ...
        public int CourageValue
        {
            get
            {
                return m_CourageValue;
            }
            set
            {
                m_CourageValue = value;
            }
        }
        ...
        /// 盾反顿帧时间
        /// </summary>
        public float StopFrameTime
        {
            get
            {
                return m_StopFrameTime;
            }
        }
        ...
        /// 盾反顿帧强度
        /// </summary>
        public float StopFrameSize
        {
            get
            {
                return m_StopFrameSize;
            }
        }

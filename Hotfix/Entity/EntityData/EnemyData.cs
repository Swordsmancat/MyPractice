...
namespace Farm.Hotfix
{
    ...
    public class EnemyData : TargetableObjectData
    {
        ...
        private int m_BehindHurtEffectID = 0;

        private List<Vector3> m_PatrolList;
        ...
        public EnemyData(int entityId ,int typeId) : base(entityId, typeId, CampType.Enemy)
        {
            ...
            TrunkValue = drEnemy.TrunkValue;
            MaxTrunk = drEnemy.TrunkValue;
            VertigoValue = drEnemy.VertigoValue;
            MaxVertigo = drEnemy.VertigoValue;
            m_BehindHurtEffectID = drEnemy.BehindHurtEffectID;
            m_PatrolList = drEnemy.PatrolList;
            GetCritEffectID = drEnemy.GetCritEffectID; 
        }

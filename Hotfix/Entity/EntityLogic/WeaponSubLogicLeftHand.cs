...
namespace Farm.Hotfix
{
    ...
    /// 武器类。
    /// </summary>
    public class WeaponSubLogicLeftHand : WeaponLogic
    {
        private const string AttachPoint_Take = "SubweaponTake_L";
        private const string AttachPoint_PutDown = "SubweaponPutDown_L";

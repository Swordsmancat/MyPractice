...
namespace Farm.Hotfix
{
   public class EnemyMotionState : EnemySeekState
    {
        protected readonly static int m_MoveBlend = Animator.StringToHash("MoveBlend");
        protected readonly static int m_InFight = Animator.StringToHash("InFight");
        protected readonly static int m_FightBlend = Animator.StringToHash("FightBlend");
        protected readonly static int m_IsBack = Animator.StringToHash("IsBack");

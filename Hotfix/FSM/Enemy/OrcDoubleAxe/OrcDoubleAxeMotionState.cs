...
{
    public class OrcDoubleAxeMotionState : EnemyMotionState
    {
      ...
      //  private readonly static int m_FightBlend = Animator.StringToHash("FightBlend");
        ...
        public static OrcDoubleAxeMotionState Create()
        {
            OrcDoubleAxeMotionState state = ReferencePool.Acquire<OrcDoubleAxeMotionState>();
            return state;
        }
